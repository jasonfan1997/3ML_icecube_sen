...
p.add_argument("--wrkdir", default="/data/condor_builds/users/jasonfan/3ml_sensitivity_v41/result_dir/", type=str,
               help="Output directory (default:res/data/condor_builds/users/jasonfan/3ml_sensitivity_v41/result_dir/ult_dir)")
...
sen = np.load("/data/condor_builds/users/jasonfan/3ml_sensitivity_v41/flux/sen_akima_0.5.npy")
threesig = np.load("/data/condor_builds/users/jasonfan/3ml_sensitivity_v41/flux/threesig_akima_0.5.npy")
...
DATA_PATH = "/data/i3store/users/mjlarson/ps_tracks/version-004-p01"
...
np.save("/data/condor_builds/users/jasonfan/3ml_sensitivity_v41/flux/result_0.5/"+str(dec)+".npy",result)
#np.save("/data/condor_builds/users/jasonfan/3ml_sensitivity_v41/flux/"+str(dec)+".npy",result)
